...
describe("Config Schema Validation", () => {
  ...
  describe("Database Config Validation", () => {
    ...
    it("should reject invalid artifact name pattern", () => {
      const config = {
        metrics: [
          {
            name: "coverage",
    ...
    it("should accept valid artifact name with hyphens and underscores", () => {
      const config = {
        metrics: [
          {
            name: "coverage",
